    ...
    <div class="post-row row mt-5 mb-5">
      <div class="post container d-flex flex-column">
        <div class="post-header row d-flex flex-column justify-content-center p-4">
          ...
          <h6 class="post-date align-self-end">
            <?= $tpl->viewVars['post']->getCreationDate(); ?>
          </h6>
        </div>
      ...
      <div class="comments-container container d-flex flex-column justify-content-between mb-5">
        ...
        <div class="comment-row row mb-5">
          ...
          <div class="comment container d-flex flex-column justify-content-between">
            ...
            <form action="<?= $tpl->basePath; ?>/admin/post/comment/delete" method="post" class="row ml-4 mb-4">
              ...
              <button type="submit" class="delete btn btn-warning btn-sm font-weight-bold font-weight-bold" name="delete">
                Supprimer
              </button>
            </form>
          </div>
