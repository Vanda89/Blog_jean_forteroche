...
var autoresize = (function () {
  ...
  var resize = function (editor, oldSize) {
    ...
    body = doc.body;
    resizeHeight = $_9qvcyv8qjikke852.getAutoResizeMinHeight(editor);
    ...
    if (myHeight > $_9qvcyv8qjikke852.getAutoResizeMinHeight(editor)) {
      resizeHeight = myHeight;
    }
    var maxHeight = $_9qvcyv8qjikke852.getAutoResizeMaxHeight(editor);
  ...
  var setup = function (editor, oldSize) {
    editor.on('init', function () {
      ...
      var dom = editor.dom;
      overflowPadding = $_9qvcyv8qjikke852.getAutoResizeOverflowPadding(editor);
      bottomMargin = $_9qvcyv8qjikke852.getAutoResizeBottomMargin(editor);
    ...
    if ($_9qvcyv8qjikke852.shouldAutoResizeOnInit(editor)) {
      editor.on('init', function () {
  ...
  var register = function (editor, oldSize) {
    editor.addCommand('mceAutoResize', function () {
      $_d6fbf08njikke84z.resize(editor, oldSize);
    });
  };
  var $_9xipj48mjikke84y = { register: register };

  global.add('autoresize', function (editor) {
    if (!editor.inline) {
      var oldSize = Cell(0);
      $_9xipj48mjikke84y.register(editor, oldSize);
      $_d6fbf08njikke84z.setup(editor, oldSize);
    }
  });
  function Plugin () {
  }
