...
var wordcount = (function () {
  ...
  var $_fswmxgsrjikkebgv = {
    each: each,
    map: map
  };

  var SETS$1 = $_7bcvlpspjikkebgq.SETS;
  var OTHER = $_7bcvlpspjikkebgq.characterIndices.OTHER;
  ...
  var classify = function (string) {
    ...
    return $_fswmxgsrjikkebgv.map(string.split(''), memoized);
  };
  var $_5kuzbjsqjikkebgt = { classify: classify };

  var ci = $_7bcvlpspjikkebgq.characterIndices;
  ...
  var $_8uq9oessjikkebgw = { isWordBoundary: isWordBoundary };

  var EMPTY_STRING$1 = $_7bcvlpspjikkebgq.EMPTY_STRING;
  var WHITESPACE$1 = $_7bcvlpspjikkebgq.WHITESPACE;
  var PUNCTUATION$1 = $_7bcvlpspjikkebgq.PUNCTUATION;
  ...
  var doGetWords = function (str, options) {
    var i = 0;
    var map = $_5kuzbjsqjikkebgt.classify(str);
    var len = map.length;
    var word = [];
    var words = [];
    var chr;
    ...
    for (; i < len; ++i) {
      chr = str.charAt(i);
      word.push(chr);
      if ($_8uq9oessjikkebgw.isWordBoundary(map, i)) {
  ...
  var $_1qual0sojikkebgo = { getWords: getWords };

  var getTextContent = function (editor) {
    return editor.removed ? '' : editor.getBody().innerText;
  };
  var getCount = function (editor) {
    return $_1qual0sojikkebgo.getWords(getTextContent(editor)).length;
  };
  var $_8veltqsnjikkebgm = { getCount: getCount };

  var get = function (editor) {
    var getCount = function () {
      return $_8veltqsnjikkebgm.getCount(editor);
    };
    return { getCount: getCount };
  };
  var $_5lpufzsmjikkebgm = { get: get };
  ...
  var setup = function (editor) {
    var wordsToText = function (editor) {
      return global$2.translate([
        '{0} words',
        $_8veltqsnjikkebgm.getCount(editor)
      ]);
    };
    var update = function () {
  ...
  var $_7cuorbstjikkebgy = { setup: setup };

  global.add('wordcount', function (editor) {
    $_7cuorbstjikkebgy.setup(editor);
    return $_5lpufzsmjikkebgm.get(editor);
  });
  function Plugin () {
  }
