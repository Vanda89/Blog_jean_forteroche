...
var preview = (function () {
  ...
  var getPreviewHtml = function (editor) {
    ...
    var contentStyle = $_f9ogxaisjikke9dt.getContentStyle(editor);
  ...
  var open = function (editor) {
    ...
    var dialogWidth = $_f9ogxaisjikke9dt.getPreviewDialogWidth(editor);
    var dialogHeight = $_f9ogxaisjikke9dt.getPreviewDialogHeight(editor);
    editor.windowManager.open({
      ...
      onPostRender: function (e) {
        ...
        $_ggiresitjikke9dv.injectIframeContent(editor, iframeElm, sandbox);
      }
    });
  };
  var $_1a8wq7iqjikke9ds = { open: open };

  var register = function (editor) {
    editor.addCommand('mcePreview', function () {
      $_1a8wq7iqjikke9ds.open(editor);
    });
  };
  var $_gf3vvkipjikke9dr = { register: register };
  ...
  var $_faqkm1ivjikke9e0 = { register: register$1 };

  global.add('preview', function (editor) {
    $_gf3vvkipjikke9dr.register(editor);
    $_faqkm1ivjikke9e0.register(editor);
  });
  function Plugin () {
  }
