...
var emoticons = (function () {
  ...
  var $_6xxfz5avjikke8df = { getHtml: getHtml };
  ...
  var register = function (editor, pluginUrl) {
    var panelHtml = $_6xxfz5avjikke8df.getHtml(pluginUrl);
  ...
  var $_d2rs3haujikke8de = { register: register };

  global.add('emoticons', function (editor, pluginUrl) {
    $_d2rs3haujikke8de.register(editor, pluginUrl);
  });
  function Plugin () {
  }
