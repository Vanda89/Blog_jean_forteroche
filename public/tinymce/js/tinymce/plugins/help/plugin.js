...
var help = (function () {
  ...
  var never$1 = $_e8ugrib4jikke8e3.never;
  var always$1 = $_e8ugrib4jikke8e3.always;
  var none = function () {
    return NONE;
  };
  var NONE = function () {
    ...
    var me = {
      ...
      toString: $_e8ugrib4jikke8e3.constant('none()')
    };
    if (Object.freeze)
      Object.freeze(me);
    return me;
  ...
  var from$1 = $_eugzonb5jikke8e5.isFunction(Array.from) ? Array.from : function (x) {
    return slice.call(x);
  };
  var $_c2a3qbb2jikke8du = {
    map: map,
    each: each,
    eachr: eachr,
    partition: partition,
  ...
  var $_cdmy42b7jikke8e9 = { shortcuts: shortcuts };
  ...
  var makeTab = function () {
    ...
    var shortcutLisString = $_c2a3qbb2jikke8du.map($_cdmy42b7jikke8e9.shortcuts, function (shortcut) {
  ...
  var $_56u3uqb1jikke8dq = { makeTab: makeTab };
  ...
  var removeLeading = function (str, prefix) {
    return startsWith(str, prefix) ? $_2plkwgbcjikke8ew.removeFromStart(str, prefix.length) : str;
  };
  var removeTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? $_2plkwgbcjikke8ew.removeFromEnd(str, prefix.length) : str;
  };
  var ensureLeading = function (str, prefix) {
    return startsWith(str, prefix) ? str : $_2plkwgbcjikke8ew.addToStart(str, prefix);
  };
  var ensureTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? str : $_2plkwgbcjikke8ew.addToEnd(str, prefix);
  };
  var contains$1 = function (str, substr) {
    return str.indexOf(substr) !== -1;
  };
  var capitalize = function (str) {
    return $_g81gfpbdjikke8ey.head(str).bind(function (head) {
      return $_g81gfpbdjikke8ey.tail(str).map(function (tail) {
  ...
  var $_eitc26bejikke8ez = { urls: urls };

  var makeLink = $_e8ugrib4jikke8e3.curry($_azdtkdbbjikke8eu.supplant, '<a href="${url}" target="_blank" rel="noopener">${name}</a>');
  var maybeUrlize = function (editor, key) {
    return $_c2a3qbb2jikke8du.find($_eitc26bejikke8ez.urls, function (x) {
      return x.key === key;
    }).fold(function () {
  ...
  var getPluginKeys = function (editor) {
    var keys = $_gaodukbajikke8ei.keys(editor.plugins);
    return editor.settings.forced_plugins === undefined ? keys : $_c2a3qbb2jikke8du.filter(keys, $_e8ugrib4jikke8e3.not($_e8ugrib4jikke8e3.curry($_c2a3qbb2jikke8du.contains, editor.settings.forced_plugins)));
  };
  var pluginLister = function (editor) {
    var pluginKeys = getPluginKeys(editor);
    var pluginLis = $_c2a3qbb2jikke8du.map(pluginKeys, function (key) {
  ...
  var $_1k23wob9jikke8eb = { makeTab: makeTab$1 };
  ...
  var $_axlwjobfjikke8f1 = { makeRow: makeRow };
  ...
  var open = function (editor, pluginUrl) {
    return function () {
      editor.windowManager.open({
        ...
        layout: 'flex',
        body: [
          $_56u3uqb1jikke8dq.makeTab(),
          $_1k23wob9jikke8eb.makeTab(editor)
        ],
        buttons: $_axlwjobfjikke8f1.makeRow(),
  ...
  var $_9gmdoyb0jikke8do = { open: open };

  var register = function (editor, pluginUrl) {
    editor.addCommand('mceHelp', $_9gmdoyb0jikke8do.open(editor, pluginUrl));
  };
  var $_23ci43azjikke8do = { register: register };

  var register$1 = function (editor, pluginUrl) {
    editor.addButton('help', {
      icon: 'help',
      onclick: $_9gmdoyb0jikke8do.open(editor, pluginUrl)
    });
  ...
  var $_505etmbhjikke8f2 = { register: register$1 };

  global.add('help', function (editor, pluginUrl) {
    $_505etmbhjikke8f2.register(editor, pluginUrl);
    $_23ci43azjikke8do.register(editor, pluginUrl);
