...
var importcss = (function () {
  ...
  var defaultConvertSelectorToFormat = function (editor, selectorText) {
    ...
    if ($_21qjl1erjikke8y3.shouldMergeClasses(editor) !== false) {
  ...
  var isExclusiveMode = function (editor, group) {
    return group === null || $_21qjl1erjikke8y3.shouldImportExclusive(editor) !== false;
  };
  ...
  var convertSelectorToFormat = function (editor, plugin, selector, group) {
    ...
    } else if ($_21qjl1erjikke8y3.getSelectorConverter(editor)) {
      selectorConverter = $_21qjl1erjikke8y3.getSelectorConverter(editor);
    } else {
  ...
  var setup = function (editor) {
    editor.on('renderFormatsMenu', function (e) {
      ...
      var selectorFilter = compileFilter($_21qjl1erjikke8y3.getSelectorFilter(editor)), ctrl = e.control;
      var groups = compileUserDefinedGroups($_21qjl1erjikke8y3.getCssGroups(editor));
      ...
      if (!$_21qjl1erjikke8y3.shouldAppend(editor)) {
        ctrl.items().remove();
      }
      global$4.each(getSelectors(editor, e.doc || editor.getDoc(), compileFilter($_21qjl1erjikke8y3.getFileFilter(editor))), function (selector) {
  ...
  var get = function (editor) {
    var convertSelectorToFormat = function (selectorText) {
      return $_afj2cqemjikke8xx.defaultConvertSelectorToFormat(editor, selectorText);
    };
    return { convertSelectorToFormat: convertSelectorToFormat };
  };
  var $_aj0uyheljikke8xv = { get: get };

  global.add('importcss', function (editor) {
    $_afj2cqemjikke8xx.setup(editor);
    return $_aj0uyheljikke8xv.get(editor);
  });
  function Plugin () {
  }
