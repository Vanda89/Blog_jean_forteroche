...
var codesample = (function () {
  ...
  var getSelectedCodeSample = function (editor) {
    ...
    if ($_9z7k18a1jikke8a3.isCodeSample(node)) {
      return node;
    }
    return null;
  };
  ...
  var getLanguages$1 = function (editor) {
    ...
    var customLanguages = $_63xk869xjikke88r.getLanguages(editor);
    return customLanguages ? customLanguages : defaultLanguages;
  };
  var getCurrentLanguage = function (editor) {
    var matches;
    var node = $_4gazpf9zjikke88t.getSelectedCodeSample(editor);
    if (node) {
  ...
  var $_4782xda2jikke8a4 = {
    getLanguages: getLanguages$1,
    getCurrentLanguage: getCurrentLanguage
  };

  var $_6wuq119wjikke88p = {
    open: function (editor) {
      var minWidth = $_63xk869xjikke88r.getDialogMinWidth(editor);
      var minHeight = $_63xk869xjikke88r.getDialogMinHeight(editor);
      var currentLanguage = $_4782xda2jikke8a4.getCurrentLanguage(editor);
      var currentLanguages = $_4782xda2jikke8a4.getLanguages(editor);
      var currentCode = $_4gazpf9zjikke88t.getCurrentCode(editor);
      editor.windowManager.open({
        ...
        onSubmit: function (e) {
          $_4gazpf9zjikke88t.insertCodeSample(editor, e.data.language, e.data.code);
        }
      });
    }
  };
  ...
  var register = function (editor) {
    editor.addCommand('codesample', function () {
      var node = editor.selection.getNode();
      if (editor.selection.isCollapsed() || $_9z7k18a1jikke8a3.isCodeSample(node)) {
        $_6wuq119wjikke88p.open(editor);
      } else {
        editor.formatter.toggle('code');
      }
    });
  };
  var $_3wdaw49vjikke88o = { register: register };

  var setup = function (editor) {
    var $ = editor.$;
    editor.on('PreProcess', function (e) {
      $('pre[contenteditable=false]', e.node).filter($_9z7k18a1jikke8a3.trimArg($_9z7k18a1jikke8a3.isCodeSample)).each(function (idx, elm) {
    ...
    editor.on('SetContent', function () {
      var unprocessedCodeSamples = $('pre').filter($_9z7k18a1jikke8a3.trimArg($_9z7k18a1jikke8a3.isCodeSample)).filter(function (idx, elm) {
  ...
  var $_n2jxxa3jikke8a7 = { setup: setup };

  var loadCss = function (editor, pluginUrl, addedInlineCss, addedCss) {
    var linkElm;
    var contentCss = $_63xk869xjikke88r.getContentCss(editor);
  ...
  var $_ais7yia4jikke8a8 = { loadCss: loadCss };
  ...
  var $_batb2fa5jikke8aa = { register: register$1 };

  var addedInlineCss = Cell(false);
  global.add('codesample', function (editor, pluginUrl) {
    var addedCss = Cell(false);
    $_n2jxxa3jikke8a7.setup(editor);
    $_batb2fa5jikke8aa.register(editor);
    $_3wdaw49vjikke88o.register(editor);
    editor.on('init', function () {
      $_ais7yia4jikke8a8.loadCss(editor, pluginUrl, addedInlineCss, addedCss);
    });
    editor.on('dblclick', function (ev) {
      if ($_9z7k18a1jikke8a3.isCodeSample(ev.target)) {
        $_6wuq119wjikke88p.open(editor);
      }
    });
  });
