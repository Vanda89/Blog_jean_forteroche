...
var contextmenu = (function () {
  ...
  var $_dte7h4agjikke8c6 = { getPos: getPos };
  ...
  var renderMenu = function (editor, visibleState) {
    ...
    var items = [];
    contextmenu = $_1id4mvafjikke8c5.getContextMenu(editor);
  ...
  var $_6pbn23ajjikke8ca = { show: show };

  var isNativeOverrideKeyEvent = function (editor, e) {
    return e.ctrlKey && !$_1id4mvafjikke8c5.shouldNeverUseNative(editor);
  };
  var setup = function (editor, visibleState, menu) {
    editor.on('contextmenu', function (e) {
      ...
      e.preventDefault();
      $_6pbn23ajjikke8ca.show(editor, $_dte7h4agjikke8c6.getPos(editor, e), visibleState, menu);
    });
  };
  var $_ymmx4aejikke8c4 = { setup: setup };

  global.add('contextmenu', function (editor) {
    var menu = Cell(null), visibleState = Cell(false);
    $_ymmx4aejikke8c4.setup(editor, visibleState, menu);
    return $_23a2xnadjikke8c3.get(visibleState);
  });
  function Plugin () {
  }
