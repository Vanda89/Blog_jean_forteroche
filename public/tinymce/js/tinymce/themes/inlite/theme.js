...
var inlite = (function () {
  ...
  var $_blksak174jikkeexe = { flatten: flatten };
  ...
  var getSelectionRect = function (editor) {
    ...
    return clientRect ? toAbsolute($_5zxd50178jikkeexi.fromClientRect(clientRect)) : null;
  };
  var $_4y9ot3177jikkeexh = {
    ...
    return function (editor) {
      for (var i = 0; i < predicateIds.length; i++) {
        if (predicateIds[i].predicate(element)) {
          var result = $_c3qshq176jikkeexg.result(predicateIds[i].id, $_4y9ot3177jikkeexh.getElementRect(editor, element));
          return result;
        }
      }
      return null;
      ...
      for (var i = 0; i < elements.length; i++) {
        for (var x = 0; x < predicateIds.length; x++) {
          if (predicateIds[x].predicate(elements[i])) {
            return $_c3qshq176jikkeexg.result(predicateIds[x].id, $_4y9ot3177jikkeexh.getElementRect(editor, elements[i]));
          }
        }
      }
      return null;
  ...
  var textSelection = function (id) {
    return function (editor) {
      if (!editor.selection.isCollapsed()) {
        var result = $_c3qshq176jikkeexg.result(id, $_4y9ot3177jikkeexh.getSelectionRect(editor));
        return result;
      }
      return null;
    };
      ...
      for (i = 0; i < elements.length; i++) {
        if (elements[i].nodeName in textBlockElementsMap) {
          if (editor.dom.isEmpty(elements[i])) {
            return $_c3qshq176jikkeexg.result(id, $_4y9ot3177jikkeexh.getSelectionRect(editor));
          }
          return null;
        }
      }
  ...
  var itemsToArray = function (value, defaultValue) {
    ...
    if ($_9wbtil17hjikkeexv.isArray(value)) {
      return value;
    } else if ($_9wbtil17hjikkeexv.isString(value)) {
      return stringToItemsArray(value);
    } else if ($_9wbtil17hjikkeexv.isBoolean(value)) {
  ...
  var $_4xj2ym17gjikkeexp = {
    getStringOr: getByTypeOr($_9wbtil17hjikkeexv.isString),
    getBoolOr: getByTypeOr($_9wbtil17hjikkeexv.isBoolean),
    getNumberOr: getByTypeOr($_9wbtil17hjikkeexv.isNumber),
    getHandlerOr: getByTypeOr($_9wbtil17hjikkeexv.isFunction),
    getToolbarItemsOr: getToolbarItemsOr($_9wbtil17hjikkeexv.isArray)
  };
  ...
  var userConstrain = function (handler, targetRect, contentAreaRect, panelRect) {
    ...
    if (typeof handler === 'function') {
      userConstrainedPanelRect = handler({
        elementRect: $_5zxd50178jikkeexi.toClientRect(targetRect),
        contentAreaRect: $_5zxd50178jikkeexi.toClientRect(contentAreaRect),
        panelRect: $_5zxd50178jikkeexi.toClientRect(panelRect)
      });
      return $_5zxd50178jikkeexi.fromClientRect(userConstrainedPanelRect);
    }
    return panelRect;
  };
  ...
  var getTextSelectionToolbarItems = function (editor) {
    return $_4xj2ym17gjikkeexp.getToolbarItemsOr(editor, 'selection_toolbar', [
      'bold',
      'italic',
      '|',
      'quicklink',
  ...
  var getInsertToolbarItems = function (editor) {
    return $_4xj2ym17gjikkeexp.getToolbarItemsOr(editor, 'insert_toolbar', [
      'quickimage',
      'quicktable'
    ]);
  };
  var getPositionHandler = function (editor) {
    return $_4xj2ym17gjikkeexp.getHandlerOr(editor, 'inline_toolbar_position_handler', $_5g7sx917ijikkeexx.defaultHandler);
  };
  ...
  var fireSkinLoaded$1 = function (editor, callback) {
    var done = function () {
      ...
      $_e27yud17djikkeexm.fireSkinLoaded(editor);
      callback();
    };
  ...
  var load = function (editor, callback) {
    var skinUrl = $_f30ijk17ejikkeexn.getSkinUrl(editor);
    var done = function () {
      fireSkinLoaded$1(editor, callback);
    };
    if ($_f30ijk17ejikkeexn.isSkinDisabled(editor)) {
      done();
    } else {
  ...
  var $_9sx1y417cjikkeexl = { load: load };
  ...
  var getToolbars = function (editor) {
    ...
    return $_blksak174jikkeexe.flatten([
  ...
  var findMatchResult = function (editor, toolbars) {
    ...
    contextToolbarsPredicateIds = $_bavrc1179jikkeexj.fromContextToolbars(toolbars);
    result = $_c3qshq176jikkeexg.match(editor, [
      $_g4pflz175jikkeexf.element(elements[0], contextToolbarsPredicateIds),
      $_9xcfeh17bjikkeexk.textSelection('text'),
      $_9xcfeh17bjikkeexk.emptyTextBlock(elements, 'insert'),
      $_g4pflz175jikkeexf.parent(elements, contextToolbarsPredicateIds)
    ]);
  ...
  var overrideLinkShortcut = function (editor, panel) {
    ...
    editor.shortcuts.add('meta+k', '', function () {
      var toolbars = getToolbars(editor);
      var result = $_c3qshq176jikkeexg.match(editor, [$_9xcfeh17bjikkeexk.textSelection('quicklink')]);
      if (result) {
        panel.show(editor, result.id, result.rect, toolbars);
      }
    });
  ...
  var renderInlineUI = function (editor, panel) {
    $_9sx1y417cjikkeexl.load(editor, function () {
  ...
  var $_7878z1170jikkeex5 = { renderUI: renderUI };
  ...
  var never$1 = $_fim84417njikkeeyf.never;
  var always$1 = $_fim84417njikkeeyf.always;
  var none = function () {
    return NONE;
  };
  var NONE = function () {
    ...
    var me = {
      ...
      toString: $_fim84417njikkeeyf.constant('none()')
    };
    if (Object.freeze)
      Object.freeze(me);
    return me;
  ...
  var from$1 = $_bbk4jv17ojikkeeyi.isFunction(Array.from) ? Array.from : function (x) {
    return slice.call(x);
  };
  var $_d41o1a17ljikkeey9 = {
    map: map,
    each: each,
    eachr: eachr,
    partition: partition,
  ...
  var proto$1 = {
    ...
    init: function (settings) {
      ...
      self.borderBox = $_chzt3g17vjikkeezh.parseBox(settings.border);
      self.paddingBox = $_chzt3g17vjikkeezh.parseBox(settings.padding);
      self.marginBox = $_chzt3g17vjikkeezh.parseBox(settings.margin);
      if (settings.hidden) {
        self.hide();
      }
    },
    ...
    getContainerElm: function () {
      var uiContainer = $_6lj9u8183jikkeezy.getUiContainer(this);
    ...
    initLayoutRect: function () {
      ...
      borderBox = self.borderBox = self.borderBox || $_chzt3g17vjikkeezh.measureBox(elm, 'border');
      self.paddingBox = self.paddingBox || $_chzt3g17vjikkeezh.measureBox(elm, 'padding');
      self.marginBox = self.marginBox || $_chzt3g17vjikkeezh.measureBox(elm, 'margin');
    ...
    reflow: function () {
      $_b2pq9l182jikkeezx.remove(this);
  ...
  function calculateRelativePosition(ctrl, targetElm, rel) {
    ...
    pos = funcs.getPos(targetElm, $_6lj9u8183jikkeezy.getUiContainer(ctrl));
    x = pos.x;
    y = pos.y;
  ...
  var getViewPortRect = function (ctrl) {
    var customUiContainer = $_6lj9u8183jikkeezy.getUiContainer(ctrl);
    return customUiContainer && !isFixed(ctrl) ? getUiContainerViewPort(customUiContainer) : getWindowViewPort();
  };
  var $_4a654u184jikkef02 = {
    ...
    moveTo: function (x, y) {
      ...
      var uiContainer = $_6lj9u8183jikkeezy.getUiContainer(self);
  ...
  var Widget = Control$1.extend({
    ...
    tooltip: function () {
      if (!this._tooltip) {
        ...
        $_6lj9u8183jikkeezy.inheritUiContainer(this, this._tooltip);
  ...
  function NotificationManagerImpl (editor) {
    ...
    var prePositionNotifications = function (notifications) {
      $_d41o1a17ljikkeey9.each(notifications, function (notification) {
    ...
    var positionNotifications = function (notifications) {
      if (notifications.length > 0) {
        ...
        $_d41o1a17ljikkeey9.each(notifications, function (notification, index) {
          if (index > 0) {
  ...
  var Window = FloatPanel.extend({
    ...
    fullscreen: function (state) {
      ...
      if (state !== self._fullscreen) {
        ...
        if (!state) {
          self.borderBox = $_chzt3g17vjikkeezh.parseBox(self.settings.border);
          ...
          self.borderBox = $_chzt3g17vjikkeezh.parseBox('0');
  ...
  var get = function (editor, panel) {
    var renderUI = function () {
      return $_7878z1170jikkeex5.renderUI(editor, panel);
    };
    return {
      renderUI: renderUI,
  ...
  var $_6h1rb016zjikkeex3 = { get: get };
  ...
  var unsafe = function (name, scope) {
    return $_4woegf18njikkef1z.resolve(name, scope);
  };
  ...
  var $_6n3lev18mjikkef1w = { getOrDie: getOrDie };

  function FileReader () {
    var f = $_6n3lev18mjikkef1w.getOrDie('FileReader');
    return new f();
  }
  ...
  var $_docpea18kjikkef1t = { blobToBase64: blobToBase64 };
  ...
  var $_4610wm18qjikkef21 = { pickFile: pickFile };
  ...
  var $_a4iqub18sjikkef24 = { uuid: uuid };
  ...
  var unwrapElements = function (editor, elms) {
    ...
    bookmark = $_6feqw118ujikkef26.create(dom, selection.getRng());
    global$4.each(elms, function (elm) {
      editor.dom.remove(elm, true);
    });
    selection.setRng($_6feqw118ujikkef26.resolve(dom, bookmark));
  };
  ...
  var $_cule2w18tjikkef25 = { unlinkSelection: unlinkSelection };
  ...
  var insertBlob = function (editor, base64, blob) {
    ...
    blobInfo = blobCache.create($_a4iqub18sjikkef24.uuid('mceu'), blob, base64);
  ...
  var unlink = function (editor) {
    editor.focus();
    $_cule2w18tjikkef25.unlinkSelection(editor);
  ...
  var addHeaderButtons = function (editor) {
    var formatBlock = function (name) {
      return function () {
        $_fwvqcc18rjikkef22.formatBlock(editor, name);
      };
    };
    for (var i = 1; i < 6; i++) {
      var name_1 = 'h' + i;
  ...
  var addToEditor = function (editor, panel) {
    ...
    editor.addButton('quickimage', {
      ...
      onclick: function () {
        $_4610wm18qjikkef21.pickFile().then(function (files) {
          var blob = files[0];
          $_docpea18kjikkef1t.blobToBase64(blob).then(function (base64) {
            $_fwvqcc18rjikkef22.insertBlob(editor, base64, blob);
          });
        });
      }
    });
    editor.addButton('quicktable', {
      ...
      onclick: function () {
        panel.hide();
        $_fwvqcc18rjikkef22.insertTable(editor, 2, 2);
      }
    });
    addHeaderButtons(editor);
  };
  var $_98bpos18jjikkef1r = { addToEditor: addToEditor };
  ...
  var $_4ov2k718yjikkef2d = { getUiContainerDelta: getUiContainerDelta$1 };
  ...
  var convertLinkToAbsolute = function (editor, href) {
    return !$_cx3ewe190jikkef2u.isAbsolute(href) && $_cx3ewe190jikkef2u.isDomainLike(href) ? askAboutPrefix(editor, href) : global$13.resolve(href);
  };
  var createQuickLinkForm = function (editor, hide) {
    var attachState = {};
    var unlink = function () {
      editor.focus();
      $_fwvqcc18rjikkef22.unlink(editor);
      hide();
    };
      ...
      onsubmit: function (e) {
        convertLinkToAbsolute(editor, e.data.linkurl).then(function (url) {
          editor.undoManager.transact(function () {
            ...
            $_fwvqcc18rjikkef22.createLink(editor, url);
          });
          hide();
        });
      }
  ...
  var $_amm7cr18zjikkef2r = { createQuickLinkForm: createQuickLinkForm };
  ...
  var itemsToArray$1 = function (items) {
    if ($_9wbtil17hjikkeexv.isArray(items)) {
      return items;
    } else if ($_9wbtil17hjikkeexv.isString(items)) {
      return items.split(/[ ,]/);
    }
    return [];
  };
    ...
    global$4.each(itemsToArray$1(items), function (item) {
      if (item === '|') {
        ...
        if (editor.buttons[item]) {
          ...
          if ($_9wbtil17hjikkeexv.isFunction(button)) {
            button = button();
          }
  ...
  var $_7dcz4g191jikkef2v = { create: create$2 };

  var create$3 = function () {
    var panel, currentRect;
    var createToolbars = function (editor, toolbars) {
      return global$4.map(toolbars, function (toolbar) {
        return $_7dcz4g191jikkef2v.create(editor, toolbar.id, toolbar.items);
      });
    };
    ...
    var create = function (editor, toolbars) {
      var items = createToolbars(editor, toolbars).concat([
        $_7dcz4g191jikkef2v.create(editor, 'text', $_f30ijk17ejikkeexn.getTextSelectionToolbarItems(editor)),
        $_7dcz4g191jikkef2v.create(editor, 'insert', $_f30ijk17ejikkeexn.getInsertToolbarItems(editor)),
        $_amm7cr18zjikkef2r.createQuickLinkForm(editor, hide)
      ]);
      return global$11.create({
        type: 'floatpanel',
        role: 'dialog',
    ...
    var repositionPanelAt = function (panel, id, editor, targetRect) {
      ...
      userConstainHandler = $_f30ijk17ejikkeexn.getPositionHandler(editor);
      contentAreaRect = $_4y9ot3177jikkeexh.getContentAreaRect(editor);
      panelRect = global$2.DOM.getRect(panel.getEl());
      if (id === 'insert') {
        result = $_5g7sx917ijikkeexx.calcInsert(targetRect, contentAreaRect, panelRect);
      } else {
        result = $_5g7sx917ijikkeexx.calc(targetRect, contentAreaRect, panelRect);
      }
      if (result) {
        var delta = $_4ov2k718yjikkef2d.getUiContainerDelta().getOr({
          x: 0,
          y: 0
        });
        ...
        movePanelTo(panel, $_5g7sx917ijikkeexx.userConstrain(userConstainHandler, targetRect, contentAreaRect, transposedPanelRect));
    ...
    var showForm = function (editor, id) {
      if (panel) {
        ...
        contentAreaRect = $_4y9ot3177jikkeexh.getContentAreaRect(editor);
        panelRect = global$2.DOM.getRect(panel.getEl());
        result = $_5g7sx917ijikkeexx.calc(currentRect, contentAreaRect, panelRect);
        if (result) {
          panelRect = result.rect;
          movePanelTo(panel, $_5g7sx917ijikkeexx.userConstrain(userConstainHandler, currentRect, contentAreaRect, panelRect));
          togglePositionClass(panel, result.position);
        }
      }
    };
    var show = function (editor, id, targetRect, toolbars) {
      if (!panel) {
        $_e27yud17djikkeexm.fireBeforeRenderUI(editor);
  ...
  var $_drszza19ojikkef4q = { generate: generate };
  ...
  var fromDom = function (node) {
    ...
    return { dom: $_fim84417njikkeeyf.constant(node) };
  };
  var fromPoint = function (doc, x, y) {
    return Option.from(doc.dom().elementFromPoint(x, y)).map(fromDom);
  };
  var $_8gu7rh19pjikkef4r = {
    fromHtml: fromHtml,
    fromTag: fromTag,
    fromText: fromText,
    fromDom: fromDom,
  ...
  var $_4vgy2819tjikkef51 = { cached: cached };

  var $_diuzg919vjikkef53 = {
    ATTRIBUTE: 2,
    CDATA_SECTION: 4,
    COMMENT: 8,
    DOCUMENT: 9,
  ...
  var isComment = function (element) {
    return type(element) === $_diuzg919vjikkef53.COMMENT || name(element) === '#comment';
  };
  var isElement = isType$2($_diuzg919vjikkef53.ELEMENT);
  var isText = isType$2($_diuzg919vjikkef53.TEXT);
  var isDocument = isType$2($_diuzg919vjikkef53.DOCUMENT);
  var $_ac7xdi19ujikkef52 = {
    name: name,
    type: type,
    value: value,
    isElement: isElement,
  ...
  var inBody = function (element) {
    var dom = $_ac7xdi19ujikkef52.isText(element) ? element.dom().parentNode : element.dom();
    return dom !== undefined && dom !== null && dom.ownerDocument.body.contains(dom);
  };
  var body = $_4vgy2819tjikkef51.cached(function () {
    return getBody($_8gu7rh19pjikkef4r.fromDom(document));
  });
  var getBody = function (doc) {
    var body = doc.dom().body;
    if (body === null || body === undefined)
      throw 'Body is not available yet';
    return $_8gu7rh19pjikkef4r.fromDom(body);
  };
  var $_etn2pb19sjikkef4z = {
    body: body,
    getBody: getBody,
    inBody: inBody
  };
  ...
  function Immutable () {
    ...
    return function () {
      ...
      var struct = {};
      $_d41o1a17ljikkeey9.each(fields, function (name, i) {
        struct[name] = $_fim84417njikkeeyf.constant(values[i]);
      });
      return struct;
    };
  }
  ...
  var validateStrArr = function (label, array) {
    if (!$_bbk4jv17ojikkeeyi.isArray(array))
      throw new Error('The ' + label + ' fields must be an array. Was: ' + array + '.');
    $_d41o1a17ljikkeey9.each(array, function (a) {
      if (!$_bbk4jv17ojikkeeyi.isString(a))
  ...
  var checkDupes = function (everything) {
    ...
    var dupe = $_d41o1a17ljikkeey9.find(sorted, function (s, i) {
  ...
  function MixedBag (required, optional) {
    ...
    $_1la8801a1jikkef5s.validateStrArr('required', required);
    $_1la8801a1jikkef5s.validateStrArr('optional', optional);
    $_1la8801a1jikkef5s.checkDupes(everything);
    return function (obj) {
      var keys = $_1d0dtv1a0jikkef5q.keys(obj);
      var allReqd = $_d41o1a17ljikkeey9.forall(required, function (req) {
        return $_d41o1a17ljikkeey9.contains(keys, req);
      });
      if (!allReqd)
        $_1la8801a1jikkef5s.reqMessage(required, keys);
      var unsupported = $_d41o1a17ljikkeey9.filter(keys, function (key) {
        return !$_d41o1a17ljikkeey9.contains(everything, key);
      });
      if (unsupported.length > 0)
        $_1la8801a1jikkef5s.unsuppMessage(unsupported);
      var r = {};
      $_d41o1a17ljikkeey9.each(required, function (req) {
        r[req] = $_fim84417njikkeeyf.constant(obj[req]);
      });
      $_d41o1a17ljikkeey9.each(optional, function (opt) {
        r[opt] = $_fim84417njikkeeyf.constant(Object.prototype.hasOwnProperty.call(obj, opt) ? Option.some(obj[opt]) : Option.none());
      });
      return r;
    };
  }

  var $_fpcq6l19xjikkef5d = {
    immutable: Immutable,
  ...
  var $_9ishaw1a2jikkef5u = { toArray: toArray };

  var node = function () {
    var f = $_6n3lev18mjikkef1w.getOrDie('Node');
    return f;
  };
  ...
  var unknown$1 = function () {
    return nu$1({
      current: undefined,
      version: $_dx9nfd1a8jikkef6c.unknown()
    });
  };
  ...
  var $_assljp1a7jikkef69 = {
    unknown: unknown$1,
    nu: nu$1,
    edge: $_fim84417njikkeeyf.constant(edge),
    chrome: $_fim84417njikkeeyf.constant(chrome),
    ie: $_fim84417njikkeeyf.constant(ie),
    opera: $_fim84417njikkeeyf.constant(opera),
    firefox: $_fim84417njikkeeyf.constant(firefox),
    safari: $_fim84417njikkeeyf.constant(safari)
  };
  ...
  var $_ax5z7k1a9jikkef6d = {
    unknown: unknown$2,
    nu: nu$2,
    windows: $_fim84417njikkeeyf.constant(windows$1),
    ios: $_fim84417njikkeeyf.constant(ios),
    android: $_fim84417njikkeeyf.constant(android),
    linux: $_fim84417njikkeeyf.constant(linux),
    osx: $_fim84417njikkeeyf.constant(osx),
    solaris: $_fim84417njikkeeyf.constant(solaris),
    freebsd: $_fim84417njikkeeyf.constant(freebsd)
  };
  ...
  function DeviceType (os, browser, userAgent) {
    ...
    return {
      isiPad: $_fim84417njikkeeyf.constant(isiPad),
      isiPhone: $_fim84417njikkeeyf.constant(isiPhone),
      isTablet: $_fim84417njikkeeyf.constant(isTablet),
      isPhone: $_fim84417njikkeeyf.constant(isPhone),
      isTouch: $_fim84417njikkeeyf.constant(isTouch),
      isAndroid: os.isAndroid,
      isiOS: os.isiOS,
      isWebView: $_fim84417njikkeeyf.constant(iOSwebview)
    };
  }

  var detect$1 = function (candidates, userAgent) {
    var agent = String(userAgent).toLowerCase();
    return $_d41o1a17ljikkeey9.find(candidates, function (candidate) {
      return candidate.search(agent);
    });
  };
  var detectBrowser = function (browsers, userAgent) {
    return detect$1(browsers, userAgent).map(function (browser) {
      var version = $_dx9nfd1a8jikkef6c.detect(browser.versionRegexes, userAgent);
      return {
  ...
  var detectOs = function (oses, userAgent) {
    return detect$1(oses, userAgent).map(function (os) {
      var version = $_dx9nfd1a8jikkef6c.detect(os.versionRegexes, userAgent);
      return {
        current: os.name,
        version: version
      };
  ...
  var removeLeading = function (str, prefix) {
    return startsWith(str, prefix) ? $_b8t37q1aejikkef6w.removeFromStart(str, prefix.length) : str;
  };
  var removeTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? $_b8t37q1aejikkef6w.removeFromEnd(str, prefix.length) : str;
  };
  var ensureLeading = function (str, prefix) {
    return startsWith(str, prefix) ? str : $_b8t37q1aejikkef6w.addToStart(str, prefix);
  };
  var ensureTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? str : $_b8t37q1aejikkef6w.addToEnd(str, prefix);
  };
  var contains$1 = function (str, substr) {
    return str.indexOf(substr) !== -1;
  };
  var capitalize = function (str) {
    return $_g7acks1afjikkef6x.head(str).bind(function (head) {
      return $_g7acks1afjikkef6x.tail(str).map(function (tail) {
  ...
  var checkContains = function (target) {
    return function (uastring) {
      return $_75hs021adjikkef6u.contains(uastring, target);
    };
  };
  var browsers = [
    {
      ...
      search: function (uastring) {
        var monstrosity = $_75hs021adjikkef6u.contains(uastring, 'edge/') && $_75hs021adjikkef6u.contains(uastring, 'chrome') && $_75hs021adjikkef6u.contains(uastring, 'safari') && $_75hs021adjikkef6u.contains(uastring, 'applewebkit');
        return monstrosity;
      }
    },
    {
      ...
      search: function (uastring) {
        return $_75hs021adjikkef6u.contains(uastring, 'chrome') && !$_75hs021adjikkef6u.contains(uastring, 'chromeframe');
      }
    },
    {
      name: 'IE',
      ...
      search: function (uastring) {
        return $_75hs021adjikkef6u.contains(uastring, 'msie') || $_75hs021adjikkef6u.contains(uastring, 'trident');
      }
    },
    {
      name: 'Opera',
    ...
    },
    {
      ...
      search: function (uastring) {
        return ($_75hs021adjikkef6u.contains(uastring, 'safari') || $_75hs021adjikkef6u.contains(uastring, 'mobile/')) && $_75hs021adjikkef6u.contains(uastring, 'applewebkit');
      }
    }
  ];
  var oses = [
    ...
    },
    {
      name: 'iOS',
      search: function (uastring) {
        return $_75hs021adjikkef6u.contains(uastring, 'iphone') || $_75hs021adjikkef6u.contains(uastring, 'ipad');
      },
      versionRegexes: [
        /.*?version\/\ ?([0-9]+)\.([0-9]+).*/,
        /.*cpu os ([0-9]+)_([0-9]+).*/,
  ...
  var $_8k3ay01acjikkef6q = {
    browsers: $_fim84417njikkeeyf.constant(browsers),
    oses: $_fim84417njikkeeyf.constant(oses)
  };

  var detect$2 = function (userAgent) {
    var browsers = $_8k3ay01acjikkef6q.browsers();
    var oses = $_8k3ay01acjikkef6q.oses();
    var browser = $_q5i601abjikkef6n.detectBrowser(browsers, userAgent).fold($_assljp1a7jikkef69.unknown, $_assljp1a7jikkef69.nu);
    var os = $_q5i601abjikkef6n.detectOs(oses, userAgent).fold($_ax5z7k1a9jikkef6d.unknown, $_ax5z7k1a9jikkef6d.nu);
  ...
  var $_7vn6ll1a6jikkef68 = { detect: detect$2 };

  var detect$3 = $_4vgy2819tjikkef51.cached(function () {
    var userAgent = navigator.userAgent;
    return $_7vn6ll1a6jikkef68.detect(userAgent);
  });
  var $_fafcvs1a5jikkef62 = { detect: detect$3 };

  var ELEMENT = $_diuzg919vjikkef53.ELEMENT;
  var DOCUMENT = $_diuzg919vjikkef53.DOCUMENT;
  ...
  var all = function (selector, scope) {
    ...
    return bypassSelector(base) ? [] : $_d41o1a17ljikkeey9.map(base.querySelectorAll(selector), $_8gu7rh19pjikkef4r.fromDom);
  };
  var one = function (selector, scope) {
    var base = scope === undefined ? document : scope.dom();
    return bypassSelector(base) ? Option.none() : Option.from(base.querySelector(selector)).map($_8gu7rh19pjikkef4r.fromDom);
  };
  var $_1pk06r1agjikkef6y = {
    all: all,
    is: is,
    one: one
  };
  ...
  var member = function (element, elements) {
    return $_d41o1a17ljikkeey9.exists(elements, $_fim84417njikkeeyf.curry(eq, element));
  };
  ...
  var ieContains = function (e1, e2) {
    return $_2t736p1a4jikkef61.documentPositionContainedBy(e1.dom(), e2.dom());
  };
  var browser = $_fafcvs1a5jikkef62.detect().browser;
  var contains$2 = browser.isIE() ? ieContains : regularContains;
  var $_6mw0uv1a3jikkef5v = {
    eq: eq,
    isEqualNode: isEqualNode,
    member: member,
    contains: contains$2,
    is: $_1pk06r1agjikkef6y.is
  };

  var owner = function (element) {
    return $_8gu7rh19pjikkef4r.fromDom(element.dom().ownerDocument);
  };
  var documentElement = function (element) {
    var doc = owner(element);
    return $_8gu7rh19pjikkef4r.fromDom(doc.dom().documentElement);
  };
  var defaultView = function (element) {
    var el = element.dom();
    var defaultView = el.ownerDocument.defaultView;
    return $_8gu7rh19pjikkef4r.fromDom(defaultView);
  };
  var parent$1 = function (element) {
    var dom = element.dom();
    return Option.from(dom.parentNode).map($_8gu7rh19pjikkef4r.fromDom);
  };
  var findIndex$1 = function (element) {
    return parent$1(element).bind(function (p) {
      var kin = children(p);
      return $_d41o1a17ljikkeey9.findIndex(kin, function (elem) {
        return $_6mw0uv1a3jikkef5v.eq(element, elem);
      });
    });
  };
  var parents = function (element, isRoot) {
    var stop = $_bbk4jv17ojikkeeyi.isFunction(isRoot) ? isRoot : $_fim84417njikkeeyf.constant(false);
    var dom = element.dom();
    var ret = [];
    while (dom.parentNode !== null && dom.parentNode !== undefined) {
      var rawParent = dom.parentNode;
      var parent = $_8gu7rh19pjikkef4r.fromDom(rawParent);
      ret.push(parent);
      if (stop(parent) === true)
        break;
      else
  ...
  var siblings = function (element) {
    var filterSelf = function (elements) {
      return $_d41o1a17ljikkeey9.filter(elements, function (x) {
        return !$_6mw0uv1a3jikkef5v.eq(element, x);
      });
    };
  ...
  var offsetParent = function (element) {
    var dom = element.dom();
    return Option.from(dom.offsetParent).map($_8gu7rh19pjikkef4r.fromDom);
  };
  var prevSibling = function (element) {
    var dom = element.dom();
    return Option.from(dom.previousSibling).map($_8gu7rh19pjikkef4r.fromDom);
  };
  var nextSibling = function (element) {
    var dom = element.dom();
    return Option.from(dom.nextSibling).map($_8gu7rh19pjikkef4r.fromDom);
  };
  var prevSiblings = function (element) {
    return $_d41o1a17ljikkeey9.reverse($_9ishaw1a2jikkef5u.toArray(element, prevSibling));
  };
  var nextSiblings = function (element) {
    return $_9ishaw1a2jikkef5u.toArray(element, nextSibling);
  };
  var children = function (element) {
    var dom = element.dom();
    return $_d41o1a17ljikkeey9.map(dom.childNodes, $_8gu7rh19pjikkef4r.fromDom);
  };
  var child = function (element, index) {
    var children = element.dom().childNodes;
    return Option.from(children[index]).map($_8gu7rh19pjikkef4r.fromDom);
  };
  ...
  var spot = $_fpcq6l19xjikkef5d.immutable('element', 'offset');
  var leaf = function (element, offset) {
    var cs = children(element);
    return cs.length > 0 && offset < cs.length ? spot(cs[offset], 0) : spot(element, offset);
  };
  var $_4qs2w219wjikkef54 = {
    owner: owner,
  ...
  var all$1 = function (predicate) {
    return descendants($_etn2pb19sjikkef4z.body(), predicate);
  };
  var ancestors = function (scope, predicate, isRoot) {
    return $_d41o1a17ljikkeey9.filter($_4qs2w219wjikkef54.parents(scope, isRoot), predicate);
  };
  var siblings$1 = function (scope, predicate) {
    return $_d41o1a17ljikkeey9.filter($_4qs2w219wjikkef54.siblings(scope), predicate);
  };
  var children$1 = function (scope, predicate) {
    return $_d41o1a17ljikkeey9.filter($_4qs2w219wjikkef54.children(scope), predicate);
  };
  var descendants = function (scope, predicate) {
    var result = [];
    $_d41o1a17ljikkeey9.each($_4qs2w219wjikkef54.children(scope), function (x) {
      if (predicate(x)) {
  ...
  var all$2 = function (selector) {
    return $_1pk06r1agjikkef6y.all(selector);
  };
  var ancestors$1 = function (scope, selector, isRoot) {
    return $_8xeke419rjikkef4w.ancestors(scope, function (e) {
      return $_1pk06r1agjikkef6y.is(e, selector);
    }, isRoot);
  };
  var siblings$2 = function (scope, selector) {
    return $_8xeke419rjikkef4w.siblings(scope, function (e) {
      return $_1pk06r1agjikkef6y.is(e, selector);
    });
  };
  var children$2 = function (scope, selector) {
    return $_8xeke419rjikkef4w.children(scope, function (e) {
      return $_1pk06r1agjikkef6y.is(e, selector);
    });
  };
  var descendants$1 = function (scope, selector) {
    return $_1pk06r1agjikkef6y.all(selector, scope);
  };
  var $_1ar119qjikkef4v = {
    all: all$2,
  ...
  var select = function (selector, root) {
    return $_d41o1a17ljikkeey9.map($_1ar119qjikkef4v.descendants($_8gu7rh19pjikkef4r.fromDom(root), selector), function (element) {
      return element.dom();
    });
  };
  ...
  var getOrGenerateId = function (elm) {
    return elm.id ? elm.id : $_drszza19ojikkef4q.generate('h');
  };
  ...
  var anchorTarget = function (elm) {
    ...
    return create$4('anchor', anchorText ? anchorText : '#' + anchorId, '#' + anchorId, 0, $_fim84417njikkeeyf.noop);
  };
  var getHeaderTargets = function (elms) {
    return $_d41o1a17ljikkeey9.map($_d41o1a17ljikkeey9.filter(elms, isValidHeader), headerTarget);
  };
  var getAnchorTargets = function (elms) {
    return $_d41o1a17ljikkeey9.map($_d41o1a17ljikkeey9.filter(elms, isValidAnchor), anchorTarget);
  };
  ...
  var find$3 = function (elm) {
    ...
    return $_d41o1a17ljikkeey9.filter(getHeaderTargets(elms).concat(getAnchorTargets(elms)), hasTitle);
  };
  var $_bnh79819njikkef4h = { find: find$3 };
  ...
  var staticMenuItem = function (title, url) {
    return {
      ...
      value: {
        title: title,
        url: url,
        attach: $_fim84417njikkeeyf.noop
      }
    };
  };
  var isUniqueUrl = function (url, targets) {
    var foundTarget = $_d41o1a17ljikkeey9.exists(targets, function (target) {
  ...
  var createMenuItems = function (term, targets, fileType, editorSettings) {
    ...
    var fromHistoryMenuItems = function (history) {
      ...
      var uniqueHistory = $_d41o1a17ljikkeey9.filter(historyItems, function (url) {
    ...
    var fromMenuItems = function (type) {
      var filteredTargets = $_d41o1a17ljikkeey9.filter(targets, function (target) {
    ...
    var join = function (items) {
      return $_d41o1a17ljikkeey9.foldl(items, function (a, b) {
  ...
  var addToHistory = function (url, fileType) {
    ...
    if (items) {
      if ($_d41o1a17ljikkeey9.indexOf(items, url).isNone()) {
  ...
  var setupAutoCompleteHandler = function (ctrl, editorSettings, bodyElm, fileType) {
    var autocomplete = function (term) {
      var linkTargets = $_bnh79819njikkef4h.find(bodyElm);
  ...
  function ClosestOrAncestor (is, ancestor, scope, a, isRoot) {
    return is(scope, a) ? Option.some(scope) : $_bbk4jv17ojikkeeyi.isFunction(isRoot) && isRoot(scope) ? Option.none() : ancestor(scope, a, isRoot);
  }

  var first$1 = function (predicate) {
    return descendant($_etn2pb19sjikkef4z.body(), predicate);
  };
  var ancestor = function (scope, predicate, isRoot) {
    ...
    while (element.parentNode) {
      ...
      var el = $_8gu7rh19pjikkef4r.fromDom(element);
      if (predicate(el))
  ...
  var sibling = function (scope, predicate) {
    ...
    if (!element.parentNode)
      return Option.none();
    return child$1($_8gu7rh19pjikkef4r.fromDom(element.parentNode), function (x) {
      return !$_6mw0uv1a3jikkef5v.eq(scope, x) && predicate(x);
    });
  };
  var child$1 = function (scope, predicate) {
    var result = $_d41o1a17ljikkeey9.find(scope.dom().childNodes, $_fim84417njikkeeyf.compose(predicate, $_8gu7rh19pjikkef4r.fromDom));
    return result.map($_8gu7rh19pjikkef4r.fromDom);
  };
  var descendant = function (scope, predicate) {
    var descend = function (element) {
      for (var i = 0; i < element.childNodes.length; i++) {
        if (predicate($_8gu7rh19pjikkef4r.fromDom(element.childNodes[i])))
          return Option.some($_8gu7rh19pjikkef4r.fromDom(element.childNodes[i]));
  ...
  var first$2 = function (selector) {
    return $_1pk06r1agjikkef6y.one(selector);
  };
  var ancestor$1 = function (scope, selector, isRoot) {
    return $_1355cb1amjikkef7l.ancestor(scope, function (e) {
      return $_1pk06r1agjikkef6y.is(e, selector);
    }, isRoot);
  };
  var sibling$1 = function (scope, selector) {
    return $_1355cb1amjikkef7l.sibling(scope, function (e) {
      return $_1pk06r1agjikkef6y.is(e, selector);
    });
  };
  var child$2 = function (scope, selector) {
    return $_1355cb1amjikkef7l.child(scope, function (e) {
      return $_1pk06r1agjikkef6y.is(e, selector);
    });
  };
  var descendant$1 = function (scope, selector) {
    return $_1pk06r1agjikkef6y.one(selector, scope);
  };
  var closest$1 = function (scope, selector, isRoot) {
    return ClosestOrAncestor($_1pk06r1agjikkef6y.is, ancestor$1, scope, selector, isRoot);
  };
  var $_4vaszn1aljikkef7k = {
    first: first$2,
    ancestor: ancestor$1,
    sibling: sibling$1,
    child: child$2,
  ...
  var $_8tra9f1aojikkef7x = { register: register };
  ...
  var $_f3875b1aqjikkef80 = { register: register$1 };
  ...
  var $_3b9l9y1arjikkef83 = { register: register$2 };
  ...
  var $_26dtcy1asjikkef85 = { register: register$3 };
  ...
  var $_6o1u021atjikkef8e = { register: register$4 };
  ...
  var createCustomMenuItems = function (editor, names) {
    ...
    if (typeof names === 'string') {
      ...
      return $_d41o1a17ljikkeey9.flatten(global$4.map(names, function (names) {
  ...
  var trimMenuItems = function (menuItems) {
    var menuItems2 = $_d41o1a17ljikkeey9.filter(menuItems, function (menuItem, i, menuItems) {
      return !isSeparator(menuItem) || !isSeparator(menuItems[i - 1]);
    });
    return $_d41o1a17ljikkeey9.filter(menuItems2, function (menuItem, i, menuItems) {
  ...
  var $_8n9zed1aujikkef8g = { register: register$5 };
  ...
  var $_nin0j1avjikkef8j = { register: register$6 };
  ...
  var $_b4p0621awjikkef8l = { register: register$7 };
  ...
  var $_cqvxfa1axjikkef8m = { register: register$8 };
  ...
  var setupUiContainer = function (editor) {
    if (editor.settings.ui_container) {
      global$1.container = $_4vaszn1aljikkef7k.descendant($_8gu7rh19pjikkef4r.fromDom(document.body), editor.settings.ui_container).fold($_fim84417njikkeeyf.constant(null), function (elm) {
        return elm.dom();
      });
    }
  };
  ...
  var setup = function (editor) {
    ...
    setupEnvironment();
    $_6o1u021atjikkef8e.register(editor);
    $_8tra9f1aojikkef7x.register(editor);
    $_nin0j1avjikkef8j.register(editor);
    $_b4p0621awjikkef8l.register(editor);
    $_3b9l9y1arjikkef83.register(editor);
    $_f3875b1aqjikkef80.register(editor);
    $_26dtcy1asjikkef85.register(editor);
    $_cqvxfa1axjikkef8m.register(editor);
    $_8n9zed1aujikkef8g.register(editor);
  };
  var $_62l9k51akjikkef78 = { setup: setup };
  ...
  var Slider = Widget.extend({
    init: function (settings) {
      ...
      self._minValue = $_bbk4jv17ojikkeeyi.isNumber(settings.minValue) ? settings.minValue : 0;
      self._maxValue = $_bbk4jv17ojikkeeyi.isNumber(settings.maxValue) ? settings.maxValue : 100;
  ...
  var getApi = function () {
    return {
      ...
      ReflowQueue: $_b2pq9l182jikkeezx,
      Control: Control$1,
      Factory: global$11,
      KeyboardNavigation: KeyboardNavigation,
      Container: Container,
      DragHelper: DragHelper,
      Scrollable: $_1emdn318gjikkef1k,
      Panel: Panel,
      Movable: $_4a654u184jikkef02,
      Resizable: $_7s96nn18hjikkef1n,
      ...
      FormatControls: $_62l9k51akjikkef78,
  ...
  global.add('inlite', function (editor) {
    var panel = create$3();
    $_62l9k51akjikkef78.setup(editor);
    $_98bpos18jjikkef1r.addToEditor(editor, panel);
    return $_6h1rb016zjikkeex3.get(editor, panel);
  });
  function Theme () {
  }
